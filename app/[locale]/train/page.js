...
import OnboardingOverlay from "@/components/train/OnboardingOverlay";
import DailyHub from "@/components/train/DailyHub";
  ...
  return (
    <main style={styles.page}>
      ...
      <section style={styles.shell}>
        ...
        {phase === "idle" && (
          <DailyHub
            ...
            missionCompletedToday={missionCompletedToday}
      ...
      {firstSessionHook && (
        <FirstSessionHook
          locale={locale}
          firstSessionHook={firstSessionHook}
          setFirstSessionHook={setFirstSessionHook}
      ...
      {readinessOpen && (
        <ReadinessModal
          ...
          setReadinessStep={setReadinessStep}
