...
export default function EventDetailPage() {
  ...
  return (
    <div style={{ ...s.page, background: `radial-gradient(ellipse at top, ${meta.color}10 0%, transparent 40%), #0B0B0C` }} className="page-enter">
      <div style={s.inner}>
...
const s = {
  ...
  heroCard: { background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", borderLeft: "3px solid #FF3B30", borderRadius: "4px 20px 20px 4px", padding: "18px 18px 20px", marginBottom: 12, backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", boxShadow: "0 8px 32px rgba(0,0,0,0.35)" },
  ...
  pastLabel: { fontSize: 11, color: "rgba(255,255,255,0.28)", fontWeight: 700 },
  eventTitle: { margin: "0 0 10px", fontSize: "clamp(20px, 6vw, 28px)", fontWeight: 1000, lineHeight: 1.1, color: "#fff", letterSpacing: "-0.01em", fontFamily: "var(--font-display, 'Anton', sans-serif)", textTransform: "uppercase" },
  eventDesc: { margin: 0, fontSize: 14, color: "rgba(255,255,255,0.55)", lineHeight: 1.6 },
  detailsCard: { background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 18, padding: "14px 16px", marginBottom: 16, display: "flex", flexDirection: "column", gap: 12, backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)" },
  detailRow: { display: "flex", alignItems: "flex-start", gap: 12 },
  detailIcon: { fontSize: 18, flexShrink: 0, marginTop: 1 },
  detailLabel: { margin: "0 0 2px", fontSize: 10, color: "rgba(255,255,255,0.38)", fontWeight: 700, textTransform: "uppercase", letterSpacing: 0.5 },
  detailValue: { margin: 0, fontSize: 14, color: "#fff", fontWeight: 700 },
  rsvpBtn: { width: "100%", padding: 16, borderRadius: 14, border: "none", background: `linear-gradient(145deg, ${RED}, #cc2820)`, color: "#fff", fontSize: 15, fontWeight: 900, cursor: "pointer", boxShadow: `0 8px 28px ${redAlpha(0.35)}, inset 0 1px 0 rgba(255,255,255,0.1)`, marginBottom: 10 },
  ...
  fullBtn: { width: "100%", padding: 16, borderRadius: 14, border: "1px solid rgba(255,255,255,0.08)", background: "transparent", color: "rgba(255,255,255,0.28)", fontSize: 15, fontWeight: 700, cursor: "not-allowed", marginBottom: 10 },
  ...
  countdownLabel: { fontSize: 11, color: "rgba(255,255,255,0.38)", fontWeight: 700, textTransform: "uppercase", letterSpacing: 0.5 },
  ...
  sectionLabel: { margin: "0 0 10px", fontSize: 10, color: RED, fontWeight: 900, textTransform: "uppercase", letterSpacing: 2.5 },
  participantGrid: { display: "flex", flexDirection: "column", gap: 8 },
  participantChip: { display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", borderRadius: 12, background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.06)", cursor: "pointer", backdropFilter: "blur(8px)", WebkitBackdropFilter: "blur(8px)" },
