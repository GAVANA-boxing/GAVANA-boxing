  ...
  return (
    <div className="page-enter" style={{ minHeight: "100dvh", background: pageBg(), display: "flex", flexDirection: "column" }}>
      ...
      >
        ...
        {/* Tracking toggle — only for boxing content */}
        {isBoxing && (
          <button
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 20, padding: "40px 0" }}>
            ...
            <div style={{ textAlign: "center", display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <p style={{ fontSize: 12, color: "rgba(255,255,255,0.35)", margin: 0, lineHeight: 1.5 }}>
                {locale === "mn" ? "Боксын бэлтгэлийн рилс оруулаад шинжилгээ авна уу" : locale === "ko" ? "복싱 훈련 릴을 업로드하여 분석을 받으세요" : "Upload a boxing training reel to get tactical analysis"}
              </p>
            </div>
            <button
