...
const sub = {
  mn: "Профайл ачааллахад алдаа гарлаа. Дахин оролдоно уу.",
  ko: "프로필 로딩 실패. 다시 시도하세요.",
  en: "This profile couldn't be loaded. Try again or go back.",
};
...
export default function ProfileError({ reset }) {
  ...
  return (
    <main style={s.page}>
      ...
      <div style={s.content}>
        <p style={s.kicker}>GAVANA // PROFILE</p>

        <div style={s.iconWrap}>
          <span style={s.icon}>👤</span>
        </div>

        <h2 style={s.title}>PROFILE NOT FOUND</h2>
