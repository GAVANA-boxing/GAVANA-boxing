    ...
    <div style={S.page} className="grain-overlay">
      ...
      <div style={S.bottomSystem}>
        ...
        <div style={{ marginTop: 8, display: "flex", gap: 12, justifyContent: "center" }}>
          <a href={`/${locale}/terms`} style={{ color: "rgba(255,255,255,0.2)", fontSize: 10, textDecoration: "none" }}>
            {locale === "mn" ? "Үйлчилгээний нөхцөл" : locale === "ko" ? "이용약관" : "Terms"}
          </a>
          <span style={{ color: "rgba(255,255,255,0.1)" }}>·</span>
          <a href={`/${locale}/privacy`} style={{ color: "rgba(255,255,255,0.2)", fontSize: 10, textDecoration: "none" }}>
