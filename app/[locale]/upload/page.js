...
const styles = {
  ...
  chooseSubtitle: { margin: 0, color: "rgba(255,255,255,0.65)", fontSize: 14 },
  ...
  typeCardDesc: { fontSize: 12, color: "rgba(255,255,255,0.62)", textAlign: "center", lineHeight: 1.4 },
  ...
  fieldLabel: { fontSize: 11, fontWeight: 900, color: "rgba(255,255,255,0.65)", textTransform: "uppercase", letterSpacing: 1 },
