...
export default function DashboardError({ reset }) {
  return (
    <div style={{
      ...
      <h2 style={{ fontSize: 18, fontWeight: 700, marginBottom: 8 }}>Dashboard ачааллахад алдаа гарлаа</h2>
      <p style={{ fontSize: 13, color: "#aaa", marginBottom: 24 }}>Дахин оролдоно уу</p>
      <button
        onClick={() => reset()}
        style={{
