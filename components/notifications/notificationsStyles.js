import { RED, BG, SURFACE_1, BORDER, RADIUS, redAlpha, GOLD, goldAlpha, whiteAlpha, blackAlpha, pageBg } from "@/lib/tokens";

const styles = {
  page: {
    minHeight: "100dvh",
    background: pageBg(0.13),
    color: "#fff",
  ...
  unreadPillMuted: {
    justifySelf: "end", minWidth: 26, height: 26, borderRadius: 13,
    background: whiteAlpha(0.06), color: whiteAlpha(0.25),
    display: "flex", alignItems: "center", justifyContent: "center",
  ...
  filterChip: {
    flexShrink: 0, padding: "6px 13px", borderRadius: RADIUS.full,
    border: `1px solid ${whiteAlpha(0.09)}`,
    background: whiteAlpha(0.04),
    color: whiteAlpha(0.5), fontSize: 12, fontWeight: 700,
  ...
  emptyText: { margin: "8px 0 0", maxWidth: 260, lineHeight: 1.55, fontSize: 13, color: whiteAlpha(0.35) },

  notification: {
    width: "100%", display: "flex", alignItems: "center", gap: 13,
    padding: "13px 14px",
    border: `1px solid ${BORDER}`,
    borderRadius: RADIUS.lg, color: "#fff", textAlign: "left", cursor: "pointer",
  ...
  avatar: {
    ...
    border: `1.5px solid ${whiteAlpha(0.1)}`,
  },
  avatarImage: { width: "100%", height: "100%", objectFit: "cover", display: "block" },
  typeBadge: {
    position: "absolute", bottom: -2, right: -4,
    width: 20, height: 20, borderRadius: "50%",
    background: SURFACE_1, border: `1.5px solid ${whiteAlpha(0.1)}`,
    display: "flex", alignItems: "center", justifyContent: "center",
  ...
  date: { color: whiteAlpha(0.28), fontSize: 10, whiteSpace: "nowrap", flexShrink: 0 },
  notificationText: { fontSize: 13, color: whiteAlpha(0.52), lineHeight: 1.4 },
  commentPreview: {
    marginTop: 5, color: whiteAlpha(0.28), fontSize: 12, lineHeight: 1.4,
    overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontStyle: "italic",
  },
  pvpScoreRow: { marginTop: 4, fontSize: 12, fontWeight: 700, color: whiteAlpha(0.45) },

  dismissBtn: {
    flexShrink: 0, width: 26, height: 26, border: "none",
    background: "transparent", color: whiteAlpha(0.2),
  ...
  toast: {
    ...
    color: "#F87171", padding: "10px 20px", borderRadius: RADIUS.md,
