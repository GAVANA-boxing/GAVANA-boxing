import { RED, RED_DARK, GOLD, BG, redAlpha, goldAlpha, pageBg } from "@/lib/tokens";
...
const S = {
  ...
  // ── Setup step
  setupPage: { minHeight: "100dvh", background: pageBg(0.12), display: "flex", flexDirection: "column" },
  setupHeader: {
  ...
  postBtn: { padding: "10px 24px", borderRadius: 999, border: "none", background: `linear-gradient(145deg, ${RED}, ${RED_DARK})`, color: "#fff", fontSize: 14, fontWeight: 900, cursor: "pointer", boxShadow: `0 4px 16px ${redAlpha(0.35)}, inset 0 1px 0 rgba(255,255,255,0.1)` },
  ...
  primaryBtn: { padding: "14px 20px", borderRadius: 14, border: "none", background: `linear-gradient(145deg, ${RED}, ${RED_DARK})`, color: "#fff", fontSize: 15, fontWeight: 900, cursor: "pointer", boxShadow: `0 8px 24px ${redAlpha(0.28)}, inset 0 1px 0 rgba(255,255,255,0.1)` },
