...
const s = {
  page: { minHeight: "100vh", background: "linear-gradient(180deg, #0d0005 0%, #070707 60%)", color: "#fff", display: "flex", flexDirection: "column" },
  ...
  postBtn: { background: "linear-gradient(135deg, #C1121F, #8f0d17)", border: "none", borderRadius: 999, padding: "9px 22px", color: "#fff", fontSize: 13, fontWeight: 900, cursor: "pointer", boxShadow: `0 4px 16px ${redAlpha(0.35)}` },
  ...
  successPage: { minHeight: "100vh", background: "#070707", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 16 },
