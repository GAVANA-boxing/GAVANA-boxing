...
const styles = {
  ...
  coverPhotoSection: {
    ...
    height: 190,
    overflow: "hidden",
    background: `linear-gradient(135deg, ${redAlpha(0.5)} 0%, #1a0404 40%, #0d0d0d 100%)`,
    marginLeft: -16,
    marginRight: -16,
  },
  coverPhotoImg: {
  ...
  coverPhotoFallback: {
    width: "100%",
    height: "100%",
    background: `radial-gradient(ellipse at 50% 20%, ${redAlpha(0.55)} 0%, ${redAlpha(0.2)} 45%, transparent 100%)`,
  },
  coverPhotoGradient: {
    position: "absolute",
    inset: 0,
    background: "linear-gradient(to bottom, rgba(0,0,0,0.08) 0%, rgba(0,0,0,0.3) 60%, rgba(7,7,7,0.88) 100%)",
    pointerEvents: "none",
  },
  coverPhotoEditBtn: {
    position: "absolute",
  ...
  xpFill: {
    ...
    boxShadow: `0 0 12px 2px ${redAlpha(0.5)}`,
    position: "relative",
  },
};
