...
const styles = {
  ...
  backBtnProfile: {
    ...
    background: "rgba(255,255,255,0.055)", color: "#fff", borderRadius: 10,
  ...
  fighterCard: {
    width: "100%",
    paddingBottom: 24,
    background: `radial-gradient(ellipse at 50% 0%, ${redAlpha(0.22)} 0%, ${redAlpha(0.04)} 40%, transparent 65%), linear-gradient(180deg, #141416 0%, #0B0B0C 100%)`,
  ...
  coverPhotoSection: {
    ...
    height: 260,
    overflow: "hidden",
    background: `linear-gradient(135deg, ${redAlpha(0.55)} 0%, #1a0404 40%, #0d0d0d 100%)`,
  },
  coverPhotoImg: { width: "100%", height: "100%", objectFit: "cover", display: "block" },
  coverPhotoFallback: {
    width: "100%", height: "100%",
    background: `radial-gradient(ellipse at 30% 40%, ${redAlpha(0.6)} 0%, ${redAlpha(0.18)} 50%, transparent 100%)`,
  },
  coverPhotoGradient: {
    position: "absolute", inset: 0,
    background: "linear-gradient(to bottom, rgba(0,0,0,0.05) 0%, rgba(0,0,0,0.25) 55%, rgba(11,11,12,0.92) 100%)",
    pointerEvents: "none",
  },
  coverPhotoEditBtn: {
  ...
  fighterUsername: {
    marginTop: 4, color: "rgba(200,200,200,0.7)", fontSize: 13, fontWeight: 750,
  },
  identityActionBtn: {
    flexShrink: 0,
    padding: "10px 18px",
  ...
  // ── Bio ───────────────────────────────────────────────────────────────────
  bio: {
    maxWidth: 480, margin: "12px 16px 0",
    color: "rgba(255,255,255,0.55)", fontSize: 12, lineHeight: 1.65,
  ...
  statLabel: {
    color: "rgba(255,255,255,0.5)", fontSize: 9, fontWeight: 850,
  ...
  followAction: {
    padding: "12px 34px", border: "none", borderRadius: 12,
  ...
  // ── XP section (legacy, kept for backward compat) ─────────────────────────
  rankRow: {
    display: "flex", alignItems: "center", justifyContent: "center",
    gap: 10, marginTop: 10, marginBottom: 2,
    background: "transparent", border: "none", cursor: "pointer",
    padding: "6px 14px", borderRadius: 14, WebkitTapHighlightColor: "transparent",
  },
