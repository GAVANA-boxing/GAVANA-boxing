...
const styles = {
  ...
  backBtn: { width: 40, height: 40, display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", color: "#fff", borderRadius: 12, cursor: "pointer", padding: 0 },
  hero: { position: "relative", height: 200, borderRadius: 18, overflow: "hidden", background: "linear-gradient(135deg,#1a1a1a,#111)", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 0, boxShadow: "0 8px 32px rgba(0,0,0,0.4)" },
  ...
  gymLocation: { margin: "4px 0 2px", fontSize: 13, color: "rgba(255,255,255,0.62)" },
  gymAddress: { margin: 0, fontSize: 12, color: "rgba(255,255,255,0.5)" },
  statsRow: { display: "flex", gap: 0, borderRadius: 16, background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", marginBottom: 16, overflow: "hidden" },
  ...
  statLbl: { fontSize: 10, color: "rgba(255,255,255,0.5)", fontWeight: 700, textTransform: "uppercase" },
  ctaRow: { display: "flex", gap: 8, marginBottom: 20, alignItems: "flex-start", flexWrap: "wrap" },
  joinBtn: { flex: 1, minHeight: 44, border: "none", borderRadius: 12, background: `linear-gradient(145deg, ${RED}, #cc2820)`, color: "#fff", fontSize: 15, fontWeight: 900, cursor: "pointer", boxShadow: `0 6px 20px ${redAlpha(0.32)}, inset 0 1px 0 rgba(255,255,255,0.1)` },
  ...
  contactBtn: { width: 44, height: 44, borderRadius: 12, border: "1px solid rgba(255,255,255,0.1)", background: "rgba(255,255,255,0.05)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16, color: "#fff", textDecoration: "none" },
  joinForm: { borderRadius: 16, border: "1px solid rgba(255,255,255,0.09)", background: "rgba(255,255,255,0.03)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", padding: "16px", marginBottom: 16, display: "flex", flexDirection: "column", gap: 10 },
  section: { marginBottom: 24 },
  sectionTitle: { margin: "0 0 10px", fontSize: 10, fontWeight: 900, color: RED, letterSpacing: 2.5, textTransform: "uppercase" },
  bodyText: { margin: 0, fontSize: 14, color: "rgba(255,255,255,0.65)", lineHeight: 1.6 },
  ...
  announcementCard: { borderRadius: "3px 14px 14px 3px", background: `${goldAlpha(0.06)}`, border: `1px solid ${goldAlpha(0.18)}`, borderLeft: `3px solid ${GOLD}`, padding: "12px 14px", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)" },
  annTitle: { margin: "0 0 4px", fontSize: 14, fontWeight: 900, color: GOLD },
  annBody: { margin: "0 0 6px", fontSize: 13, color: "rgba(255,255,255,0.65)", lineHeight: 1.5 },
  annDate: { fontSize: 11, color: "rgba(255,255,255,0.45)" },
  ...
  reviewForm: { borderRadius: 14, border: "1px solid rgba(255,255,255,0.09)", background: "rgba(255,255,255,0.03)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", padding: 16, marginBottom: 16, display: "flex", flexDirection: "column", gap: 10 },
  reviewList: { display: "flex", flexDirection: "column", gap: 10 },
  reviewCard: { borderRadius: 12, border: "1px solid rgba(255,255,255,0.07)", background: "rgba(255,255,255,0.025)", backdropFilter: "blur(10px)", WebkitBackdropFilter: "blur(10px)", padding: "12px 14px" },
  reviewTop: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 },
  reviewDate: { fontSize: 11, color: "rgba(255,255,255,0.45)" },
  reviewText: { margin: 0, fontSize: 13, color: "rgba(255,255,255,0.62)", lineHeight: 1.5 },
  textarea: { width: "100%", boxSizing: "border-box", padding: "10px 12px", borderRadius: 10, border: "1px solid rgba(255,255,255,0.1)", background: "rgba(255,255,255,0.05)", color: "#fff", fontSize: 14, resize: "none", outline: "none", fontFamily: "inherit" },
  cancelBtn: { flex: 1, minHeight: 40, border: "1px solid rgba(255,255,255,0.1)", borderRadius: 10, background: "transparent", color: "rgba(255,255,255,0.45)", fontSize: 14, fontWeight: 700, cursor: "pointer" },
  submitBtn: { flex: 2, minHeight: 40, border: "none", borderRadius: 10, background: `linear-gradient(145deg, ${RED}, #cc2820)`, color: "#fff", fontSize: 14, fontWeight: 900, cursor: "pointer", boxShadow: `0 6px 18px ${redAlpha(0.28)}` },
  errorText: { margin: 0, fontSize: 13, color: "#F87171" },
  successText: { margin: "0 0 10px", fontSize: 13, color: "#34D399", fontWeight: 700 },
  emptyText: { margin: 0, fontSize: 13, color: "rgba(255,255,255,0.45)" },
  ...
  goodForPill: { fontSize: 12, color: "rgba(255,255,255,0.62)", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 999, padding: "4px 12px", fontWeight: 600 },
  ...
  memberName: { fontSize: 10, fontWeight: 700, color: "rgba(255,255,255,0.45)", maxWidth: 44, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", textAlign: "center" },
};
