...
const styles = {
  ...
  tabBar: {
    ...
    display: "flex", background: blackAlpha(0.94),
    backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)",
    borderBottom: `1px solid ${whiteAlpha(0.05)}`, paddingTop: "env(safe-area-inset-top)",
  },
  tabActive: { flex: 1, minHeight: 46, border: "none", borderBottom: `2px solid ${RED}`, background: "transparent", color: "#fff", fontSize: 13, fontWeight: 900, cursor: "pointer", letterSpacing: 0.3 },
  ...
  searchInput: { width: "100%", boxSizing: "border-box", padding: "12px 16px", borderRadius: RADIUS.full, border: `1px solid ${BORDER_2}`, background: whiteAlpha(0.04), color: "#fff", fontSize: 14, outline: "none", marginBottom: 14 },
  ...
  loadingText: { textAlign: "center", padding: "60px 0", color: whiteAlpha(0.55), fontSize: 14 },
  skeletonList: { display: "flex", flexDirection: "column", gap: 12, marginBottom: 16 },
  skeletonCard: { height: 200, borderRadius: RADIUS.lg, background: whiteAlpha(0.05) },
  cardList: { display: "flex", flexDirection: "column", gap: 16 },
  card: { borderRadius: RADIUS.lg, border: `1px solid ${BORDER}`, background: whiteAlpha(0.045), backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", overflow: "hidden", cursor: "pointer", boxShadow: `0 8px 32px ${blackAlpha(0.35)}, inset 0 1px 0 ${whiteAlpha(0.05)}` },
  ...
  cardLogo: { width: 64, height: 64, objectFit: "cover", borderRadius: 14, boxShadow: `0 8px 24px ${blackAlpha(0.5)}` },
  ...
  verifiedBadge: { position: "absolute", top: 10, right: 10, fontSize: 10, fontWeight: 900, color: GOLD, background: goldAlpha(0.15), border: `1px solid ${goldAlpha(0.35)}`, borderRadius: RADIUS.full, padding: "3px 8px" },
  ...
  typeChip: { fontSize: 10, fontWeight: 900, color: RED, background: redAlpha(0.12), border: `1px solid ${redAlpha(0.25)}`, borderRadius: RADIUS.full, padding: "2px 8px" },
  cardLocation: { fontSize: 12, color: whiteAlpha(0.55), marginBottom: 6 },
  cardRating: { display: "flex", alignItems: "center", gap: 6, marginBottom: 6 },
  reviewCount: { fontSize: 11, color: whiteAlpha(0.45) },
  cardStats: { display: "flex", flexWrap: "wrap", gap: 6, marginBottom: 6 },
  statChip: { fontSize: 11, color: whiteAlpha(0.45), background: whiteAlpha(0.05), borderRadius: 8, padding: "3px 8px" },
  cardDesc: { margin: 0, fontSize: 12, color: whiteAlpha(0.55), lineHeight: 1.5 },
  cardVibeRow: { display: "flex", flexWrap: "wrap", gap: 5, marginBottom: 8 },
  cardVibeBadge: { fontSize: 10, fontWeight: 800, color: "#F87171", background: redAlpha(0.08), border: `1px solid ${redAlpha(0.2)}`, borderRadius: RADIUS.full, padding: "2px 8px" },
  vibeRow: { display: "flex", gap: 8, overflowX: "auto", paddingBottom: 8, marginBottom: 12, scrollbarWidth: "none" },
  vibeBtn: { flexShrink: 0, padding: "5px 14px", borderRadius: RADIUS.full, border: `1px solid ${redAlpha(0.2)}`, background: redAlpha(0.05), color: "rgba(255,165,130,0.65)", fontSize: 12, fontWeight: 700, cursor: "pointer" },
  vibeActive: { flexShrink: 0, padding: "5px 14px", borderRadius: RADIUS.full, border: `1px solid ${redAlpha(0.6)}`, background: redAlpha(0.18), color: "#F87171", fontSize: 12, fontWeight: 900, cursor: "pointer" },
  memberCountBadge: { position: "absolute", bottom: 8, left: 10, fontSize: 10, fontWeight: 900, color: "#fff", background: blackAlpha(0.65), borderRadius: RADIUS.full, padding: "2px 8px" },
  joinBtn: { display: "block", width: "100%", marginTop: 10, padding: "10px 0", borderRadius: 12, border: "none", background: `linear-gradient(145deg, ${RED}, ${RED_DARK})`, color: "#fff", fontSize: 13, fontWeight: 900, cursor: "pointer", letterSpacing: 0.3, boxShadow: `0 4px 14px ${redAlpha(0.18)}, inset 0 1px 0 ${whiteAlpha(0.1)}` },
  ...
  featuredCard: { flexShrink: 0, width: 116, display: "flex", flexDirection: "column", alignItems: "center", gap: 4, background: whiteAlpha(0.04), backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: `1px solid ${goldAlpha(0.15)}`, borderRadius: RADIUS.md, padding: "12px 8px", cursor: "pointer", textAlign: "center", WebkitTapHighlightColor: "transparent" },
  ...
  featuredCity: { margin: 0, fontSize: 10, color: whiteAlpha(0.35), overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", width: "100%" },
  featuredRating: { fontSize: 10, color: GOLD, fontWeight: 800 },
  featuredMembers: { fontSize: 10, color: whiteAlpha(0.35) },
};
