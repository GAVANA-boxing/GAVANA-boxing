...
const styles = {
  ...
  joinBtn: { display: "block", width: "100%", marginTop: 10, padding: "10px 0", borderRadius: 12, border: "none", background: `linear-gradient(145deg, ${RED}, #cc2820)`, color: "#fff", fontSize: 13, fontWeight: 900, cursor: "pointer", letterSpacing: 0.3, boxShadow: `0 6px 20px ${redAlpha(0.3)}, inset 0 1px 0 rgba(255,255,255,0.1)` },
