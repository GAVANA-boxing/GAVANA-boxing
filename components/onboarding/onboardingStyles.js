import { GOLD, RED, RED_DARK, BG, BORDER, BORDER_2, RADIUS, redAlpha, whiteAlpha, blackAlpha, pageBg } from "@/lib/tokens";
...
const s = {
  ...
  roleCard: {
    ...
    boxShadow: `0 4px 20px ${blackAlpha(0.2)}`,
  },

  archetypeGrid: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 18 },
  archetypeCard: {
    padding: "18px 12px 14px", borderRadius: RADIUS.lg, cursor: "pointer",
  ...
  archetypeDesc: { fontSize: 11, color: whiteAlpha(0.42), lineHeight: 1.35 },
  selectedDot: { position: "absolute", top: 8, right: 8, width: 8, height: 8, borderRadius: "50%" },

  weightSection: { marginBottom: 20 },
  fieldLabel: {
    display: "block", fontSize: 10, color: whiteAlpha(0.45), fontWeight: 900,
    letterSpacing: 2, textTransform: "uppercase", marginBottom: 8,
  },
  select: {
    width: "100%", padding: "12px 14px", borderRadius: 12,
    border: `1px solid ${whiteAlpha(0.1)}`, background: whiteAlpha(0.05),
    color: "#fff", fontSize: 14, outline: "none", colorScheme: "dark", boxSizing: "border-box",
  },

  primaryBtn: {
    width: "100%", padding: 15, borderRadius: RADIUS.lg, border: "none",
    background: `linear-gradient(145deg, ${RED}, ${RED_DARK})`,
    color: "#fff", fontSize: 15, fontWeight: 900, cursor: "pointer",
    boxShadow: `0 10px 32px ${redAlpha(0.34)}, inset 0 1px 0 ${whiteAlpha(0.12)}`,
    letterSpacing: 0.5,
  },
  primaryBtnDisabled: {
    width: "100%", padding: 15, borderRadius: RADIUS.lg, border: "none",
    background: redAlpha(0.16), color: whiteAlpha(0.28),
  ...
  gymSkeleton: { height: 64, borderRadius: RADIUS.lg, background: whiteAlpha(0.04) },
  gymCard: {
    display: "flex", alignItems: "center", justifyContent: "space-between",
    gap: 10, padding: "12px 14px", borderRadius: RADIUS.lg,
    background: whiteAlpha(0.04), border: `1px solid ${BORDER_2}`,
    backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)",
  },
  gymCardLeft: { display: "flex", alignItems: "center", gap: 10, flex: 1, minWidth: 0 },
  gymLogo: { width: 40, height: 40, borderRadius: RADIUS.sm, objectFit: "cover", flexShrink: 0 },
  gymLogoFallback: {
    width: 40, height: 40, borderRadius: RADIUS.sm, background: redAlpha(0.14),
  ...
  gymMeta: { margin: "1px 0 0", fontSize: 11, color: whiteAlpha(0.4) },
  joinBtn: {
    padding: "8px 16px", borderRadius: RADIUS.full, border: "none",
    background: redAlpha(0.85), color: "#fff", fontSize: 12, fontWeight: 900,
    cursor: "pointer", flexShrink: 0,
  },
  joinBtnDisabled: {
    padding: "8px 16px", borderRadius: RADIUS.full, border: `1px solid ${BORDER_2}`,
    background: "transparent", color: whiteAlpha(0.22), fontSize: 12,
    fontWeight: 900, cursor: "not-allowed", flexShrink: 0,
  },
  joinedBtn: {
    padding: "8px 16px", borderRadius: RADIUS.full, border: "1px solid rgba(52,211,153,0.28)",
  ...
  skipBtn: {
    ...
    border: `1px solid ${whiteAlpha(0.09)}`, background: "transparent",
    color: whiteAlpha(0.4), fontSize: 13, fontWeight: 800, cursor: "pointer",
  },
  ...
  ghostBtn: {
    ...
    border: `1px solid ${whiteAlpha(0.1)}`, background: "transparent",
    color: whiteAlpha(0.55), fontSize: 14, fontWeight: 800, cursor: "pointer",
  },
};
