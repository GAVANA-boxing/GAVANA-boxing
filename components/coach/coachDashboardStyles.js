...
const styles = {
  ...
  statsPanel: {
    ...
    boxShadow: "0 0 0 0.5px rgba(0,0,0,0.5) inset, 0 8px 32px rgba(0,0,0,0.2)",
  },
  ...
  statLbl: { fontSize: 10, color: "rgba(255,255,255,0.65)", fontWeight: 700, textTransform: "uppercase", letterSpacing: 0.5 },
  statDivider: { width: 1, height: 32, background: "rgba(255,255,255,0.08)" },
  sectionTitle: { margin: "0 0 14px", fontSize: 15, fontWeight: 1000, color: "rgba(255,255,255,0.7)", letterSpacing: 0.5, textTransform: "uppercase" },
  loadingText: { textAlign: "center", padding: "40px 0", color: "rgba(255,255,255,0.62)", fontSize: 14 },
  emptyState: {
    display: "flex", flexDirection: "column", alignItems: "center", gap: 10,
    padding: "52px 24px", borderRadius: 18,
    background: "rgba(255,255,255,0.025)",
    backdropFilter: "blur(18px)", WebkitBackdropFilter: "blur(18px)",
    border: "1px solid rgba(255,255,255,0.07)", textAlign: "center",
  },
  emptyIcon: { fontSize: 44, opacity: 0.5 },
  emptyTitle: { fontSize: 18, fontWeight: 1000, color: "rgba(255,255,255,0.7)" },
  emptyDesc: { fontSize: 13, color: "rgba(255,255,255,0.55)", lineHeight: 1.5, maxWidth: 260 },
  ...
  cardTime: { fontSize: 11, color: "rgba(255,255,255,0.58)", fontWeight: 600 },
  badgePending: {
  ...
  cardMessage: {
    margin: 0, fontSize: 13, color: "rgba(255,255,255,0.6)", lineHeight: 1.5,
    fontStyle: "italic", borderLeft: "2px solid rgba(255,255,255,0.1)", paddingLeft: 10,
  },
  ...
  skeletonCard: { height: 88, borderRadius: 16, background: "rgba(255,255,255,0.06)" },
  cardActions: { display: "flex", gap: 8, marginTop: 2 },
  scheduleBtn: {
    width: "100%", minHeight: 38, border: `1px solid ${goldAlpha(0.35)}`,
    borderRadius: 10, background: `${goldAlpha(0.08)}`, color: GOLD,
    fontSize: 13, fontWeight: 900, cursor: "pointer", marginTop: 2,
  },
  bookedTag: { fontSize: 12, color: "#34D399", fontWeight: 700, paddingTop: 2 },
  modalSubtitle: { fontSize: 13, color: "rgba(255,255,255,0.65)", marginTop: -8, fontWeight: 700 },
  modalField: { display: "flex", flexDirection: "column", gap: 6 },
  modalLabel: { fontSize: 11, fontWeight: 900, color: "rgba(255,255,255,0.65)", textTransform: "uppercase", letterSpacing: 0.8 },
  modalInput: {
  ...
  acceptBtn: {
    flex: 2, minHeight: 38, border: "none", borderRadius: 10,
