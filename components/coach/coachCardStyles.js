...
export const coachCardStyles = {
  ...
  verifiedBadge: {
    ...
    borderRadius: 999, padding: "1px 7px", letterSpacing: 0.5,
  },
  cardLocation: { fontSize: 12, color: "rgba(255,255,255,0.55)", fontWeight: 600 },
  ...
  cardBio: {
    margin: 0, fontSize: 13, color: "rgba(255,255,255,0.62)", lineHeight: 1.5,
  ...
  createPostBtn: {
    ...
    borderRadius: 14, background: `linear-gradient(135deg, ${redAlpha(0.9)}, ${goldAlpha(0.2)})`,
  ...
  sparringLocation: { fontSize: 12, color: "rgba(255,255,255,0.55)", fontWeight: 600 },
  sparringTime: { fontSize: 12, color: "rgba(255,255,255,0.55)", fontWeight: 600 },
