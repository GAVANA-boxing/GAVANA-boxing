...
const s = {
  ...
  coachTag: { fontSize: 9, fontWeight: 900, color: GOLD, background: goldAlpha(0.12), border: `1px solid ${goldAlpha(0.35)}`, borderRadius: RADIUS.full, padding: "2px 6px", letterSpacing: 0.3 },
  ...
  badge: { flexShrink: 0, minWidth: 22, height: 22, borderRadius: RADIUS.full, background: `linear-gradient(135deg, ${RED}, ${RED_DARK})`, color: "#fff", fontSize: 10, fontWeight: 900, display: "flex", alignItems: "center", justifyContent: "center", padding: "0 6px", boxShadow: `0 2px 8px ${redAlpha(0.5)}` },
