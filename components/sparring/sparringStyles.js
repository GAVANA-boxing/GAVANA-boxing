...
const s = {
  ...
  tabBar: { display: "flex", borderBottom: "1px solid rgba(255,255,255,0.07)", background: "rgba(7,7,7,0.96)", position: "sticky", top: "calc(52px + env(safe-area-inset-top))", zIndex: 19 },
  tabBtn: { flex: 1, padding: "12px 4px", border: "none", background: "transparent", color: "rgba(255,255,255,0.35)", fontSize: 12, fontWeight: 800, cursor: "pointer", position: "relative", display: "flex", alignItems: "center", justifyContent: "center", gap: 5, borderBottom: "2px solid transparent", transition: "all 200ms ease" },
  tabBtnActive: { color: "#fff", borderBottom: "2px solid #C1121F" },
  tabBadge: { minWidth: 16, height: 16, borderRadius: 999, background: RED, color: "#fff", fontSize: 9, fontWeight: 900, display: "inline-flex", alignItems: "center", justifyContent: "center", padding: "0 4px" },
  toggleBanner: { borderRadius: 14, border: "1px solid", padding: "12px 14px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, transition: "all 300ms ease" },
  ...
  toggleBtn: { flexShrink: 0, padding: "8px 14px", borderRadius: 999, fontSize: 12, fontWeight: 900, cursor: "pointer", whiteSpace: "nowrap", transition: "all 200ms ease" },
  ...
  filterChip: { flexShrink: 0, padding: "6px 12px", borderRadius: 999, border: "1px solid rgba(255,255,255,0.09)", background: "rgba(255,255,255,0.03)", color: "rgba(255,255,255,0.38)", fontSize: 12, fontWeight: 700, cursor: "pointer", whiteSpace: "nowrap" },
  weightSelect: { width: "100%", padding: "9px 12px", borderRadius: 10, border: "1px solid rgba(255,255,255,0.09)", background: "rgba(255,255,255,0.04)", color: "rgba(255,255,255,0.55)", fontSize: 12, outline: "none", appearance: "none" },
  ...
  empty: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "48px 32px", gap: 10 },
...
const c = {
  ...
  avatarFallback: { width: 48, height: 48, borderRadius: "50%", border: "1px solid rgba(255,255,255,0.08)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, fontWeight: 900, color: "#fff" },
  ...
  chip: { fontSize: 10, fontWeight: 800, color: "rgba(255,255,255,0.45)", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 999, padding: "2px 8px" },
  location: { fontSize: 11, color: "rgba(255,255,255,0.3)", marginBottom: 3 },
  bio: { fontSize: 12, color: "rgba(255,255,255,0.4)", lineHeight: 1.45 },
  msgBtn: { width: "100%", padding: "10px", borderRadius: 10, border: "none", color: "#fff", fontSize: 13, fontWeight: 900, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 7, boxShadow: `0 4px 16px ${redAlpha(0.25)}` },
