// Fighter-specific technique lessons with transferable coach cues.
// Each lesson teaches the mechanic that makes the fighter elite,
// then explains how any boxer can apply the same principle.
  ...
  "mike-tyson": [
    {
      ...
      drillSteps: [
        ...
        "Speed build: partner throws fight-speed jabs, you slip and counter without telegraphing the slip",
      ],
      diagramLabel: "SLIP + HOOK ENTRY",
    },
    {
  ...
  "naoya-inoue": [
    ...
    },
    {
      ...
      drillSteps: [
        ...
        "Speed progression: slow → medium → full speed slips over multiple sessions",
      ],
      diagramLabel: "SLIP + COUNTER",
    },
    {
  ...
  "vasyl-lomachenko": [
    {
      ...
      coachNotes:
        "Foot position determines which punches are available. When your foot is inside, you're in their danger zone. Step outside and you flip the geometry. One step changes everything.",
      drillSteps: [
        "Against orthodox dummy: place right foot outside their lead foot, feel the angle difference",
        "Shadow with marker: every entry, right foot must land outside center line",
        "Partner: enter with outside foot, notice their cross cannot reach you cleanly",
        "Full combo from angle: outside step → left straight → right hook → left hook from new position",
      ],
      diagramLabel: "FOOT GEOMETRY",
    },
    {
      ...
      diagramLabel: "MULTI-ANGLE ASSAULT",
    },
    {
  ...
  "canelo-alvarez": [
    {
      ...
      diagramLabel: "SHOULDER DEFLECTION",
    },
    {
    ...
    },
    {
      ...
      coachNotes:
        "Body shots are investments. Each one forces the opponent to think about their ribs. By punch 5 or 6, their guard drifts down automatically. That head is now yours. Commit to real body shots — the brain ignores fake threats.",
      drillSteps: [
      ...
      diagramLabel: "BODY ACCUMULATION",
    },
  ],
  ...
  "floyd-mayweather": [
    {
      ...
      drillSteps: [
        "Mirror drill: hold Philly Shell position 60 seconds — right hand by jaw, left arm diagonal, shoulder forward",
        "Walk one full round in Shell position — feel what's protected without anything incoming",
        "Partner light touch: partner taps shoulder area, practice rolling with it — let shoulder absorb",
        "Counter from Shell: partner jabs, shoulder deflects, immediate left hand return — no cocking",
      ],
      diagramLabel: "SHELL POSITION",
    },
    {
      title: "Catch & Counter",
      explanation:
  ...
  "manny-pacquiao": [
    {
      ...
      drillSteps: [
        "Drill the step: against partner, practice only stepping outside their foot 20 reps before any punch",
        "Add the punch: outside foot placement, then left straight down the center",
        "Partner check: after your foot placement, partner tries their right cross — it should miss",
        "Speed entry: from distance, explosive single step to outside foot position, immediate left straight",
      ],
      diagramLabel: "SOUTHPAW ENTRY",
    },
    {
