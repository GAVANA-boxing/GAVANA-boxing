...
export const FIGHTERS = [
  {
    ...
    accent: "#FF3B30",
    imageUrl: "https://firebasestorage.googleapis.com/v0/b/gavana-boxing-89a22.firebasestorage.app/o/Fighters%2Fmike-tyson.jpg%2FIMG_3477.jpeg?alt=media&token=540b04fb-416f-4a68-99c6-04f5393b25f1",
    bio: {
      en: "The most feared heavyweight in boxing history. Trained under Cus D'Amato, Tyson combined elite head movement with explosive peekaboo entries to produce one of the most terrifying knockout records ever assembled.",
      mn: "Боксын түүхэн дэх хамгийн аймшигтай хэнтэй бокс хийснийг ч мэдэхгүй байх гэж оролдсон хяналтгүй хүч. Кус Д'Амато түүнийг дэлхийн хамгийн аюултай тулаанч болгон бэлтгэсэн.",
      ko: "복싱 역사상 가장 두려운 헤비급 선수. 피카부 스타일과 폭발적인 움직임으로 상대를 공포에 빠뜨렸다.",
    },
...

  {
    ...
    accent: "#F5C451",
    imageUrl: "https://firebasestorage.googleapis.com/v0/b/gavana-boxing-89a22.firebasestorage.app/o/Fighters%2Fmuhammad-ali.jpg%2FIMG_3476.jpeg?alt=media&token=b78e497d-3620-45cd-8326-108ebbd3dbb1",
    bio: {
      en: "The Greatest of All Time redefined heavyweight boxing with impossible speed, poetic trash talk, and a social courage that transcended sport. Three-time world heavyweight champion.",
      mn: "Бүх цагийн хамгийн шилдэг. Тэрбээр боксын урлагийг дахин тодорхойлж, ринг дээрх алхалт нь шүлэг, цохилт нь гал байсан.",
      ko: "역사상 최고의 복서. 헤비급에서 불가능한 스피드와 우아함으로 세상을 바꾼 전설.",
    },
...

  {
    ...
    accent: "#F97316",
    imageUrl: "https://firebasestorage.googleapis.com/v0/b/gavana-boxing-89a22.firebasestorage.app/o/Fighters%2Fnaoya-inoue.jpg%2FIMG_3479.jpeg?alt=media&token=7a0e81ca-c4eb-44a1-a5f2-f18733a00757",
    bio: {
      en: "Pound-for-pound No.1. The Monster dismantles opponents with surgical body attacks and explosive counters. Undisputed super bantamweight champion with the most fearsome finishing rate in modern boxing.",
      mn: "Жингийн ангиас гадна хамгийн аюултай тулаанч. Биеийн дайралт болон тэсрэх counter-аар өрсөлдөгчдийг сэтгэл санааны хувьд устгадаг.",
      ko: "체급을 초월한 최강자. 몬스터의 정밀한 바디 어택과 폭발적인 카운터는 현대 복싱 최고의 피니싱률을 자랑한다.",
    },
...

  {
    ...
    accent: "#3B82F6",
    imageUrl: "https://firebasestorage.googleapis.com/v0/b/gavana-boxing-89a22.firebasestorage.app/o/Fighters%2Fdmitry-bivol.jpg%2FIMG_3480.jpeg?alt=media&token=4d813d9c-7a9d-499b-b334-f0221037dee0",
    bio: {
      en: "The Soviet technical machine who shocked the world by defeating Canelo Álvarez. Bivol controls distance with a metronome jab and punishes every mistake with textbook right hands.",
      mn: "Канело Альварезыг ялснаар дэлхийг цочоосон Зөвлөлтийн техникийн машин. Алхийн зайг ноёрхож, зөв гарын цохилтоор бүх алдааг шийтгэдэг.",
      ko: "카넬로를 꺾으며 세상을 놀라게 한 소련의 기술 머신. 정교한 잽으로 거리를 지배한다.",
    },
...

  {
    ...
    accent: "#A855F7",
    imageUrl: "https://firebasestorage.googleapis.com/v0/b/gavana-boxing-89a22.firebasestorage.app/o/Fighters%2Fvasyl-lomachenko.jpg%2FIMG_3481.jpeg?alt=media&token=b3374527-0ac5-4fb0-bec4-3922a5482daf",
    bio: {
      en: "The most technically gifted boxer alive. Lomachenko's Matrix-like footwork and pivot combinations create angles that exist nowhere else in boxing. Two-time Olympic gold medalist.",
      mn: "Амьд байгаа хамгийн техникийн хувьд авьяастай боксчин. Ломаченкогийн матриксын хэв маягийн алхалт нь бусдын бодоогүй өнцгүүдийг бий болгодог.",
      ko: "현존하는 가장 기술적으로 뛰어난 복서. 매트릭스 같은 풋워크와 피벗 조합으로 독보적인 각도를 만든다.",
    },
...

  {
    ...
    accent: "#F59E0B",
    imageUrl: "https://firebasestorage.googleapis.com/v0/b/gavana-boxing-89a22.firebasestorage.app/o/Fighters%2Fcanelo-alvarez.jpg%2FIMG_3482.jpeg?alt=media&token=b65d53a0-f4d4-4247-8a5d-6007bf19722a",
    bio: {
      en: "Mexico's greatest modern champion, Canelo evolved from a raw power puncher into a complete technical fighter. His shoulder roll and devastating counter hooks have unified multiple world titles.",
      mn: "Мексикийн хамгийн шилдэг орчин үеийн аварга. Канело нь мөрний roll болон хокк counter-аараа дэлхийн олон титмийг нэгтгэсэн.",
      ko: "멕시코 최고의 현대 챔피언. 숄더롤과 파괴적인 카운터 훅으로 여러 세계 타이틀을 통합했다.",
    },
...

  {
    ...
    accent: "#10B981",
    imageUrl: "https://firebasestorage.googleapis.com/v0/b/gavana-boxing-89a22.firebasestorage.app/o/Fighters%2Fgennady-golovkin.jpg%2FIMG_3475.jpeg?alt=media&token=02db6cac-7236-4519-acc7-0db0b42e4b88",
    bio: {
      en: "Triple G — the Kazakhstan destroyer who terrorized the middleweight division for a decade. His relentless volume, nuclear right hand, and iron will made him the most feared middleweight of his generation.",
      mn: "Казахстаны устгагч — Triple G нь арван жилийн турш дунд жингийн ангийг айдас хүйдэсэд автуулсан. Тасралтгүй эзэмшил, цөмийн баруун гар нь түүнийг хамгийн аймшигтай болгосон.",
      ko: "10년간 미들급을 지배한 카자흐스탄의 파괴자. 쉬지 않는 공격량과 핵폭탄 같은 오른손으로 세대 최강의 미들급으로 군림했다.",
    },
...

  {
    ...
    accent: "#94A3B8",
    imageUrl: "https://firebasestorage.googleapis.com/v0/b/gavana-boxing-89a22.firebasestorage.app/o/Fighters%2Ffloyd-mayweather.jpg%2FIMG_3478.jpeg?alt=media&token=f337c471-6d2d-4849-9ef9-bab1d9ac109b",
    bio: {
      en: "50-0. The undefeated master of Philly Shell defense combined scientific ring craft with once-in-a-century athletic gifts. The most complete defensive fighter in boxing history, never hurt in 50 fights.",
      mn: "50-0. Ялагдлыг мэдэхгүй Флойд Мэйвезер боксын түүхэн дэх хамгийн бүрэн хамгаалалтын тулаанч байв. 50 тулаанд хэзээ ч хохирол хүлээгээгүй.",
      ko: "50전 50승. 역사상 가장 완벽한 수비형 복서. 50번의 경기에서 단 한 번도 다운되지 않았다.",
    },
...

  {
    ...
    accent: "#FCD34D",
    imageUrl: "https://firebasestorage.googleapis.com/v0/b/gavana-boxing-89a22.firebasestorage.app/o/Fighters%2Fmanny-pacquiao.jpg%2FIMG_3483.jpeg?alt=media&token=d99a5b02-dcf8-4317-a243-7648340bc37b",
    bio: {
      en: "8-division world champion from the Philippines. Pacquiao's southpaw blitz — all angles, maximum speed, relentless combination volume — made him the most electrifying offensive force in boxing's modern era.",
      mn: "Филиппинээс гарсан 8 жингийн ангийн дэлхийн аварга. Пакяогийн зүүн гарын дайрлага нь хамгийн цахилгаан мэт довтолгооны хүч байсан.",
      ko: "필리핀 출신 8체급 세계 챔피언. 팍맨의 사우스포 블리츠는 현대 복싱 최고의 공격 폭발력이었다.",
    },
...

  {
    ...
    accent: "#DC2626",
    imageUrl: "https://firebasestorage.googleapis.com/v0/b/gavana-boxing-89a22.firebasestorage.app/o/Fighters%2Froberto-duran.jpg%2FIMG_3485.jpeg?alt=media&token=766877f6-6ff3-4785-8c8f-cfe9b78cad6a",
    bio: {
      en: "Hands of Stone. The most naturally gifted fighter ever produced. Durán's street-level ferocity and infighting mastery dominated four weight classes across three decades of unmatched violence.",
      mn: "Чулуун гар. Байгалиас заяагдсан хамгийн авьяастай тулаанч. Дуранийн гудамжны ширүүн зан болон дотроо тулаанцах мэдлэг нь дөрвөн жингийн ангийг ноёрхсон.",
      ko: "돌주먹. 역사상 가장 타고난 파이터. 거리 싸움의 맹렬함과 인파이팅 기술로 4개 체급을 지배했다.",
    },
