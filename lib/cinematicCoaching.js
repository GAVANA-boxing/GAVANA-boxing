 ...
 *
 * Returns { type: "strength" | "improve", message: string }[]
 * ordered: improvements first, strengths second.
 *
...
const STRAIGHT_ANGLE    = 135; // below this = hook/uppercut
...
export function generateCoachingMessages(sessionSummary, punchEvents = []) {
  ...
  const breakdown   = computePunchBreakdown(punchEvents);
