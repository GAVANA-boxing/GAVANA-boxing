...
// ── Evolution timeline ─────────────────────────────────────────────────────────
const EVO_LABELS = {
  session1:      { en: "First session complete",       mn: "Эхний session дуусгав",         ko: "첫 번째 세션 완료"        },
  session5:      { en: "5 sessions trained",            mn: "5 session дасгалласан",          ko: "5세션 훈련 완료"          },
  session10:     { en: "10 sessions milestone",         mn: "10 session-ийн milestone",       ko: "10세션 마일스톤"          },
  session25:     { en: "25 sessions grinder",           mn: "25 session — тогтвортой тулаанч", ko: "25세션 달성"             },
  session50:     { en: "50 sessions veteran",           mn: "50 session — ветеран тулаанч",   ko: "50세션 베테랑"           },
  ...
  score8:        { en: "Hit 8.0+ — strong session",     mn: "8.0+ авлаа — хүчтэй session",   ko: "8.0+ 기록 — 강한 세션"   },
  jabWeapon:     { en: "Jab became your best weapon",   mn: "Jab шилдэг зэвсэг болов",       ko: "잽이 주요 무기가 됨"     },
  crossWeapon:   { en: "Cross became your best weapon", mn: "Cross шилдэг зэвсэг болов",      ko: "크로스가 주요 무기가 됨" },
  hookWeapon:    { en: "Hook is a real threat now",     mn: "Hook аюулын зэвсэг болов",       ko: "훅이 위협이 됨"          },
  pressureRise:  { en: "Pressure style intensified",    mn: "Дарамтын хэв маяг нэмэгдэв",    ko: "압박 스타일 강화"        },
  outboxerRise:  { en: "Outboxer movement increased",   mn: "Хөдлөгч хэв маяг нэмэгдэв",     ko: "아웃복서 움직임 증가"   },
  guardImproved: { en: "Guard recovery improved",       mn: "Guard буцалт сайжарлаа",         ko: "가드 회복 향상"          },
