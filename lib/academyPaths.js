export const ACADEMY_PATHS = [
  {
    ...
    description: {
      en: "Master the six core mechanics every boxer must own.",
      mn: "Тулаанчдын суурь 6 техникийг эзэмш.",
  ...
  },
  {
    ...
    description: {
      en: "Survive and respond — guard, slipping, rolling, and exits.",
      mn: "Амьд үлж хариулт өг — хамгаалалт, гулгах, эргэлт.",
  ...
  },
  {
    ...
    description: {
      en: "How champions apply fundamentals — punches, slips, rolls, and counters.",
