export const ACADEMY_PATHS = [
  {
    ...
    difficulty: "beginner",
    estimatedMinutes: 25,
    lessonIds: ["jab-mechanics", "cross-mechanics", "hook-mechanics", "guard-recovery", "footwork-angle-exit"],
  ...
  },
  {
    ...
    estimatedMinutes: 15,
    lessonIds: ["cross-mechanics", "hook-mechanics"],
  ...
  },
  {
    ...
    difficulty: "intermediate",
    estimatedMinutes: 15,
    lessonIds: ["guard-recovery", "footwork-angle-exit"],
  ...
  },
  {
    ...
    difficulty: "advanced",
    estimatedMinutes: 20,
    lessonIds: ["jab-mechanics", "cross-mechanics", "hook-mechanics"],
